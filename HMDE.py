...
class HMDE:
    ...
    def execute_h_mde(self):
        print(f'--Starting H-MDE optimization | m = {self.n_clusters} clusters')
        ...
        while first_time is True or self.check_stopping_criterion(p):
            ...
            for index, solution in enumerate(p.solutions):
                ...
                phi, generated_coordinate_matrix = greedy_generation(solution=solution,
                ...
                if phi == 1:
                    ...
                    raise Exception('Phi value error')
