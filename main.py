...
if __name__ == '__main__':
    ...
    for dataset in ['ionosphere.txt', 'page.txt', 'pendigit.txt']:
        ...
        for seed in [16007, 10000, 12345, 00000, 56789]:
            ...
            for cluster_seq in [2, 5, 10, 15, 30]:
                ...
                solution = gmde(points=points, size=population_size, max_iteration=max_iteration, n_clusters=cluster_seq, matching_type=matching, do_verbose=verbose)
                # solution = dmde(points=points, size=population_size, max_iteration=max_iteration, n_clusters=cluster_seq, matching_type=matching, do_verbose=verbose)
                # solution = hmde(points=points, size=population_size, max_iteration=max_iteration, n_clusters=cluster_seq, matching_type=matching, do_verbose=verbose)
